...
class niko_MPC_generateUltima: BaseCommand {
    ...
    private fun setupMooredShips(stagingStation: SectorEntityToken) {
        ...
        storage.addMothballedShip(FleetMemberType.SHIP, "eradicator_Outdated", "MBAC Stalwart")
        storage.addMothballedShip(FleetMemberType.SHIP, "eradicator_Outdated", "MBAC Eyes of Terra")
        ...
        for (member in storage.mothballedShips.membersListCopy) {
            ...
            if (chance > niko_MPC_genericCommand.CHANCE_FOR_MOORED_DMODS) continue
