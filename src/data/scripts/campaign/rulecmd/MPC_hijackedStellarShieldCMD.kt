...
class MPC_hijackedStellarShieldCMD: BaseCommandPlugin() {
    override fun execute(
        ...
        when (command) {
            "startMusic" -> {
                ...
                MPC_addDelayedMusicScript("music_encounter_mysterious").start() // doesnt work if you go through a wormhole otehrwise
            }
            "endMusic" -> {
