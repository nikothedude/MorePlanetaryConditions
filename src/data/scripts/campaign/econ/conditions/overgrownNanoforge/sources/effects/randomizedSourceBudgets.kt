...
enum class randomizedSourceBudgets(
    ...
    MEDIUM(22f, 100f*OVERGROWN_NANOFORGE_OVERALL_BUDGET_MULT),
    ...
    INSANE(0.5f, 300f*OVERGROWN_NANOFORGE_OVERALL_BUDGET_MULT),
    EXOTIC(0.1f, 500f*OVERGROWN_NANOFORGE_OVERALL_BUDGET_MULT),
}
