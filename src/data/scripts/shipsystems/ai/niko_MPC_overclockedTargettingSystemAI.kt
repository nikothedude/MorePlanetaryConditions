...
import data.scripts.shipsystems.niko_MPC_coreOverclockedTargettingSystemStats
    ...
    override fun doLogic(amount: Float, missileDangerDir: Vector2f?, collisionDangerDir: Vector2f?, target: ShipAPI?) {
        ...
        for (weapon in ship!!.usableWeapons) {
            ...
            if (weapon.isPD()) {
                ...
                val modifiedPDRange = weapon.range * niko_MPC_coreOverclockedTargettingSystemStats.rangeMult
