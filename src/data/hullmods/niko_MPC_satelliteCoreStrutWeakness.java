...
public class niko_MPC_satelliteCoreStrutWeakness extends niko_MPC_structuralWeakness {

    @Override
    protected void addTypeSpecificWeaknessIds() {
        weaknessTagIds.add(niko_MPC_structuralWeaknessIds.satelliteCoreStrutWeaknessTag);
    }
