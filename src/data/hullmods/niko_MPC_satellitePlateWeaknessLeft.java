...
public class niko_MPC_satellitePlateWeaknessLeft extends niko_MPC_structuralWeakness{

    @Override
    protected void addTypeSpecificWeaknessIds() {
        weaknessTagIds.add(niko_MPC_structuralWeaknessIds.satellitePlateWeaknessLeftTag);
    }
